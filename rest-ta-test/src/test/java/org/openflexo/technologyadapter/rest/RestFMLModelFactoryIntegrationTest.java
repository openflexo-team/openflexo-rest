...
public class RestFMLModelFactoryIntegrationTest extends AbstractModelFactoryIntegrationTestCase {

	private static final Logger logger = FlexoLogger.getLogger(RestFMLModelFactoryIntegrationTest.class.getPackage().getName());
	...
	public void initializeServiceManager() {
		...
		assertNotNull(taService.getTechnologyAdapter(RestTechnologyAdapter.class));
	}
	...
	@Test
	@TestOrder(2)
	public void checkRestFMLTechnologyAdapter() {
		log("checkRestFMLTechnologyAdapter()");

		testVirtualModelModelFactoryWithTechnologyAdapter(
				serviceManager.getTechnologyAdapterService().getTechnologyAdapter(RestTechnologyAdapter.class));
	}
