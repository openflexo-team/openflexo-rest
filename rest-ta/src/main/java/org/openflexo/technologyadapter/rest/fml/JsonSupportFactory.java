...
import org.openflexo.technologyadapter.rest.fml.JsonSupport.JsonResponse;
import org.openflexo.technologyadapter.rest.model.ContentSupportFactory;
...
public class JsonSupportFactory implements ContentSupportFactory<JsonSupport, JsonResponse> {
	...
	@Override
	public List<JsonSupport> newSupports(RestVirtualModelInstance owner, JsonResponse response) {
	...
	@Override
	public JsonSupport newSupport(RestVirtualModelInstance owner, JsonResponse response) {
		return new JsonSupport(owner, response);
	}

	private String getPath(RestVirtualModelInstance owner, ObjectNode node) {
		...
		logger.warning("Hop, des trucs a voir ici aussi");
