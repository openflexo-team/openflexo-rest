...
package org.openflexo.technologyadapter.rest.binding;
...
public final class RestBindingFactory extends TechnologyAdapterBindingFactory {
	static final Logger logger = Logger.getLogger(RestBindingFactory.class.getPackage().getName());

	public RestBindingFactory() {
		super();
	}
