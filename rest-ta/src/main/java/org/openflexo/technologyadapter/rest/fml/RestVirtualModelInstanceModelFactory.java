 ...
 * 
 */
public class RestVirtualModelInstanceModelFactory
		extends ReflectedVirtualModelInstanceModelFactory<RestAccessPointResource, RestAccessPoint, RestTechnologyAdapter, JsonSupport> {

	private static final Logger logger = FlexoLogger.getLogger(RestVirtualModelInstanceModelFactory.class.getPackage().toString());

	public RestVirtualModelInstanceModelFactory(RestAccessPointResource resource, EditingContext editingContext,
