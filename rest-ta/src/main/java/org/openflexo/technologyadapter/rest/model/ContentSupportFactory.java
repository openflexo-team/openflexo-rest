 ...
 * {@link org.openflexo.technologyadapter.rest.fml.HttpFlexoConceptInstance}.
 */
public interface ContentSupportFactory<S extends ContentSupport<T>, T extends Object> {
	 ...
	 */
	List<S> newSupports(RestVirtualModelInstance owner, T supportObject);
	 ...
	 */
	S newSupport(RestVirtualModelInstance owner, T supportObject);
