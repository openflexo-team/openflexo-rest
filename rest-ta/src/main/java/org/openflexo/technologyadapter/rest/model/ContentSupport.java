...
/**
 * A {@link ContentSupport} instance provides value storage for an {@link org.openflexo.technologyadapter.rest.fml.HttpFlexoConceptInstance}.
 *
...
public interface ContentSupport<T extends Object> {
	...
	/**
	 * Distant object identifier, relative the owning {@link org.openflexo.technologyadapter.rest.fml.HttpVirtualModelInstance}. It's used to
