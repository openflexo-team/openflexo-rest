 ...
 */
public class AccessPointModuleView extends FIBModuleView<RestAccessPoint> {

	public static Resource HTTP_MODULE_VIEW_FIB = ResourceLocator.locateResource("Fib/HttpModuleView.fib");

	private final FlexoPerspective perspective;

	public AccessPointModuleView(RestAccessPoint accessPoint, FlexoController controller, FlexoPerspective perspective) {
